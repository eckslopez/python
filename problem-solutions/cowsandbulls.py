...
if __name__=="__main__":
    ...
    number = str(random.randint(0,9999)) # 4 digit random number
    guesses = 0

    print("Let's play a game of Cowbull!") 
    print("I will generate a number, and you guess the numbers one digit at a time.")
    print("For every number in the correct place, you get a cow. For every one in the wrong place, you get a bull.")
