...
# For each range in ranges, loop through items, splitting each item in half, by character count (ex: 123123 => 123 123)
# If each half of the split is the same, that's an invalid ID, put it in the invalid_ids[] list
# sum(invalid_ids)
...
def test(file):
    ...
    try:
        ...
        print(f"Error: The file '{ranges}' was not found.")
    
    return content   

if __name__ == "__main__":
    test("aoc/test-ranges.txt")
    main(sys.argv[1])
